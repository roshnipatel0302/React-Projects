  ...
  return (
    <div className="flex items-center justify-center">
            <div className={`mx-auto w-full max-w-lg bg-gray-700 rounded-xl p-8 border border-black/10`}>
                <h2 className="text-center text-2xl font-bold leading-tight text-gray-100">Sign up to create account</h2>
                ...
                <form onSubmit={handleSubmit(create)}>
                    <div className='space-y-5 text-gray-100'>
                        ...
                        {...register("password", {
                            required: true,})}
                        />
                        <Button type="submit" className="w-full bg-pink-700 hover:bg-pink-800">
                            Create Account
                        </Button>
                    </div>
                </form>
